      ...
      <section className="section-padding bg-white">
        <div className="container-main max-w-3xl mx-auto">
          <div className="space-y-8 text-sm text-gray-700 leading-relaxed">
            ...
            <div>
              <h2 className="text-base font-bold text-[#1a3a5c] mb-3">제1조 (목적)</h2>
              <p>
            ...
            <div>
              <h2 className="text-base font-bold text-[#1a3a5c] mb-3">제2조 (용어의 정의)</h2>
            ...
            <div>
              <h2 className="text-base font-bold text-[#1a3a5c] mb-3">제3조 (약관의 효력과 변경)</h2>
              <p>
            ...
            <div>
              <h2 className="text-base font-bold text-[#1a3a5c] mb-3">제4조 (서비스 이용)</h2>
              <p>
            ...
            <div>
              <h2 className="text-base font-bold text-[#1a3a5c] mb-3">제5조 (수강료 및 환불)</h2>
              <p>
                수강료, 검정료, 자격증 발급비 등 비용에 관한 사항은 각 서비스 안내 페이지에서 확인하실 수 있습니다.
                환불에 관한 사항은 <Link href="/refund" className="text-[#1a3a5c] underline">환불규정</Link>을 따릅니다.
              </p>
            </div>

            <div>
              <h2 className="text-base font-bold text-[#1a3a5c] mb-3">제6조 (이용자의 의무)</h2>
              <ul className="space-y-2 list-disc list-inside">
            ...
            <div>
              <h2 className="text-base font-bold text-[#1a3a5c] mb-3">제7조 (지식재산권)</h2>
              <p>
            ...
            <div>
              <h2 className="text-base font-bold text-[#1a3a5c] mb-3">제8조 (면책조항)</h2>
              <p>
            ...
            <div>
              <h2 className="text-base font-bold text-[#1a3a5c] mb-3">제9조 (분쟁 해결)</h2>
              <p>
            ...
            <div className="bg-gray-50 rounded-xl p-5">
              ...
              <p>전화: <a href="tel:042-254-8060" className="text-[#1a3a5c] hover:underline">042-254-8060</a></p>
              <p>이메일: <a href="mailto:dj@ccej.or.kr" className="text-[#1a3a5c] hover:underline">dj@ccej.or.kr</a></p>
            </div>
          </div>
        </div>
      </section>
