...
const REFUND_RULES = [
  ...
  { period: '수강 시작 후 1/3 경과 전', rate: '수강료의 2/3 환불', color: 'text-brand-700 bg-brand-50' },
  { period: '수강 시작 후 1/2 경과 전', rate: '수강료의 1/2 환불', color: 'text-warning-600 bg-warning-50' },
...
export default function RefundPage() {
  return (
    <>
      <PageHero
        title="환불규정"
        description="학원의 설립·운영 및 과외교습에 관한 법률 제18조에 따른 환불기준"
        breadcrumb={[
          { label: '홈', href: '/' },
          { label: '환불규정' },
        ]}
      ...
      <section className="section-padding bg-white">
        <div className="container-main max-w-2xl mx-auto">
          ...
          <div className="space-y-5 text-sm text-gray-700 leading-relaxed">
            <div>
              <h3 className="font-bold text-brand-600 mb-2">환불 신청 방법</h3>
              <p>환불 신청은 전화(042-254-8060) 또는 이메일(dj@ccej.or.kr)로 접수하시기 바랍니다.
              환불 처리는 영업일 기준 3~5일 소요됩니다.</p>
            </div>
            <div>
              <h3 className="font-bold text-brand-600 mb-2">유의사항</h3>
