      ...
      <div className="max-w-md w-full">
        ...
        <div className="bg-white rounded-2xl p-8 shadow-xl">
          <div className="flex items-center justify-center w-14 h-14 bg-green-100 rounded-full mx-auto mb-5">
            <CheckCircle size={28} className="text-cta-700" aria-hidden="true" />
          </div>
          ...
          <div className="bg-brand-50 border border-brand-200 rounded-lg p-4 mb-6">
            <p className="text-xs font-semibold text-brand-800 mb-2">📋 진행 순서</p>
            <ol className="text-sm text-brand-700 space-y-1.5">
          ...
          <div className="space-y-2 mb-6">
            <a
              ...
              className="flex items-center gap-3 p-3 border border-gray-200 rounded-lg hover:border-cta-700 hover:bg-green-50 transition-colors"
            >
              <Phone size={16} className="text-cta-700" aria-hidden="true" />
            ...
            <a
              ...
              className="flex items-center gap-3 p-3 border border-gray-200 rounded-lg hover:border-cta-700 hover:bg-green-50 transition-colors"
            >
              <Mail size={16} className="text-cta-700" aria-hidden="true" />
          ...
          <div className="pt-4 border-t border-gray-100 text-center">
            <Link
              href="/"
              className="text-sm text-cta-700 hover:underline font-medium"
            >
              홈으로 돌아가기
            </Link>
          </div>
