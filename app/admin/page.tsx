...
const MENUS = [
  ...
  { icon: Download, title: '자료실 관리', desc: '자료 파일 업로드·수정·삭제', href: '/admin/files' },
]
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-10">
          {MENUS.map(({ icon: Icon, title, desc, href }) => (
            <Link
              key={href}
              href={href}
              className="bg-gray-800 border border-gray-700 rounded-xl p-5 hover:border-brand-600 transition-colors"
            >
