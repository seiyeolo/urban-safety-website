...
const INFO_PILLS = [
  { label: '교육 기간', value: '4주 (총 20시간)' },
  { label: '교육 방식', value: '온라인/오프라인' },
  { label: '이수 기준', value: '진도율 80% 이상' },
            ...
            <div className="space-y-4">
              {[
                ...
                },
                {
                  ...
                  a: '온라인 교육과 실시간 특강 참여로 자격증 취득이 가능합니다. 4주간의 체계적인 온라인 강의와 주차별 과제 수행, 최종 평가를 통해 자격증을 받을 수 있으며, 필요시 오프라인 보충 교육도 제공됩니다.'
                },
                {
                  q: '자격증 활용도는 어떻게 되나요?',
