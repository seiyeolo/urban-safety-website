...
export const onlineCourses = [
  {
    ...
    level: '입문~실무',
    summary:
      '보이스피싱 유형 이해, 시민 대상 예방 설명, 의심 상황 대응 흐름을 온라인에서 복습하는 mock 강의실입니다.',
    outcomes: ['사례 기반 위험 신호 분류', '피해 예방 안내 스크립트 작성', '기관 교육용 체크리스트 활용'],
    stats: [
      { label: '총 차시', value: '6강', icon: BookOpen },
      { label: '학습 시간', value: '7시간', icon: Clock },
      { label: '자료', value: '4종', icon: FileText },
      { label: '평가', value: '퀴즈 mock', icon: ClipboardCheck },
    ],
  },
  {
...
export const voicePhishingLessons = [
  {
    id: 'lesson-01',
    order: 1,
    title: '보이스피싱 예방교육의 목적과 지도사 역할',
    duration: '42분',
    status: 'current' as LessonStatus,
    summary: '예방지도사가 시민에게 설명해야 할 핵심 역할과 수업 운영 흐름을 정리합니다.',
    materials: ['강의 요약 PDF', '예방 안내 스크립트 초안'],
  },
  {
    id: 'lesson-02',
    order: 2,
    title: '주요 사기 유형과 위험 신호 분류',
    duration: '55분',
    status: 'locked' as LessonStatus,
    summary: '기관 사칭, 가족 사칭, 투자 사기, 메신저 피싱 등 유형별 위험 신호를 분류합니다.',
    materials: ['위험 신호 체크리스트'],
  },
  {
    id: 'lesson-03',
    order: 3,
    title: '상담·신고·피해 확산 방지 대응 흐름',
    duration: '48분',
    status: 'locked' as LessonStatus,
    summary: '의심 상황에서 무엇을 멈추고, 어디에 확인하고, 누구에게 알릴지 흐름을 설계합니다.',
    materials: ['대응 플로우차트'],
  },
  {
    id: 'lesson-04',
    order: 4,
    title: '시민 대상 5분 설명 실습',
    duration: '50분',
    status: 'locked' as LessonStatus,
    summary: '고령층·청년층·기관 담당자별 설명 톤을 비교하고 짧은 안내문을 작성합니다.',
    materials: ['설명 스크립트 워크시트'],
  },
  {
    id: 'lesson-05',
    order: 5,
    title: '교육 현장 운영과 질문 대응',
    duration: '45분',
    status: 'locked' as LessonStatus,
    summary: '수업 중 자주 나오는 질문과 민감한 피해 경험을 다룰 때의 주의사항을 정리합니다.',
    materials: ['FAQ 카드'],
  },
  {
    id: 'lesson-06',
    order: 6,
    title: '복습 퀴즈와 수료 기준 안내',
    duration: '38분',
    status: 'locked' as LessonStatus,
    summary: 'mock 퀴즈로 핵심 개념을 점검하고 수료/자격 검정 안내 문구를 확인합니다.',
    materials: ['복습 퀴즈 mock'],
  },
]
...
export const safetyGates = [
  '실제 수강생 개인정보 없이 가명 mock 데이터만 사용',
  '실제 영상 업로드 없이 플레이어 placeholder만 사용',
